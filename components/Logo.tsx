...
export default function Logo({ 
  ...
  return (
    ...
    >
      ...
      <line x1="65" y1="60" x2="70" y2="70" stroke="currentColor" strokeWidth="1.5" className="text-blue-400" />
      ...
      <line x1="160" y1="65" x2="160" y2="55" stroke="currentColor" strokeWidth="2" className="text-gray-600 dark:text-gray-300" />
      <line x1="155" y1="75" x2="155" y2="90" stroke="currentColor" strokeWidth="2" className="text-gray-600 dark:text-gray-300" />
      <line x1="170" y1="85" x2="170" y2="95" stroke="currentColor" strokeWidth="2" className="text-gray-600 dark:text-gray-300" />
      
      {/* Branch End Nodes */}
      <circle cx="160" cy="55" r="2" fill="currentColor" className="text-purple-400" />
      <circle cx="155" cy="90" r="2" fill="currentColor" className="text-purple-400" />
      <circle cx="170" cy="95" r="2" fill="currentColor" className="text-purple-400" />
